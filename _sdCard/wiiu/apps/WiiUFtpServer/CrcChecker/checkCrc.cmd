...
REM  2022-02-28:Laf111:V1-3: Take the new format of report into account
REM ****************************************************************************
set "VERSION=V1-3"
...
REM : main
    ...
    set "crc32_report_unsorted="WiiUFtpServer_crc32_report.sfv""

    set "logFile="!HERE:"=!\checkCrc.log""
    set "crcErrorFiles="!HERE:"=!\crcErrors.txt""
    set "missings="!HERE:"=!\missings.txt""
    ...
    type !THIS_SCRIPT! | find "convertedToAinsi" | find /V "find" > NUL 2>&1 && (
        ...
        type !THIS_SCRIPT! > !convertedFile!
    ...
    echo  -==============================-
    echo.
    if not exist !crc32_report_unsorted! (
        echo !crc32_report_unsorted! not found
        echo.
    ...
    if not exist !crc32_report_unsorted! (
        ...
        set "sfvFile="/storage_sdcard/wiiu/apps/WiiUFtpServer/CrcChecker/!crc32_report_unsorted:"=!""
        ...
        if not exist !crc32_report_unsorted! (
            echo ERROR ^: fail to download !crc32_report_unsorted!
            echo please check the IP passed and if WiiUFtpServer is running
            if %nbArgs% EQU 0 pause
            exit /b 50
        )
    )
    set "crc32_report="WiiUFtpServer_crc32_report_sorted.sfv""
    del /F !crc32_report! > NULL 2>&1
    type !crc32_report_unsorted! | sort > !crc32_report!
...
REM call !computeFileCrc! !fullFolderPath! !file!
REM pause
        )
