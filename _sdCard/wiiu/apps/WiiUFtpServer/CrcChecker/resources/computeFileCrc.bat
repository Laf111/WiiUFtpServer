...
REM : main
    ...
    set "missings="!CrcCheckerFolder:"=!\missings.txt""
    ...
    if not ["!relativePath!"] == [""] set "relativePath=%relativePath:\=/%"
    ...
    if [!line!] == ["NOT_FOUND"] (
        echo CRC_INFO  : !file! not found in WiiUFtpServer CRC32 report >> !missings!
